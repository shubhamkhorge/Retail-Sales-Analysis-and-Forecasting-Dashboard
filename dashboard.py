        ...
        if os.path.exists(file_path):
            ...
            try:
                ...
                try:
                    ...
                    st.error(
                        f"Error parsing 'Date' column in '{file_path}': {e_date_parse}. "
...
def main():
    ...
    # Header
    st.markdown(
        '<h1 class="main-header">🛍️ Retail Sales Analytics Dashboard</h1>',
        unsafe_allow_html=True,
    )
    ...
    if uploaded_file is not None:
        ...
        try:
            ...
            try:
                ...
                st.error(
                    f"Error parsing 'Date' column from uploaded file: {e_date_parse}. "
